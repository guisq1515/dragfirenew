...
export interface TelemetryConfig {
  ...
  enableDynamicBraking?: boolean;   // Show braking zone warning
  brakingSensitivity?: number;      // Multiplier for braking distance calculation (default 1.0)
  enableHeatmapTrajectory?: boolean;// Colorize minimap line (Red->Yellow->Green)
  heatmapSensitivity?: number;      // Controls length/spread of heatmap zones (default 1.0)
  heatmapSensitivity?: number;      // Controls length/spread of heatmap zones (default 1.0)
  ...
  curveContextMeters?: number;      // Straight ends for real curve shape (default 10)
